  ...
  return (
    <>
      ...
      <button
        ...
        className={cn(
          "fixed bottom-[84px] right-4 sm:bottom-6 sm:right-6 p-4 rounded-full shadow-lg text-white transition-all duration-300 z-[9999] hover:scale-110",
      ...
      <div
        className={cn(
          "fixed bottom-[84px] right-4 sm:bottom-6 sm:right-6 w-[calc(100vw-2rem)] sm:w-80 md:w-[400px] h-[520px] sm:h-[600px] max-h-[75vh] sm:max-h-[85vh] bg-[#1a1f2e] border border-gray-800 rounded-2xl shadow-2xl flex flex-col transition-all duration-300 z-[9999] overflow-hidden",
