  ...
  return (
    <>
      ...
      <button
        ...
        className={cn(
          "fixed bottom-6 right-6 p-4 rounded-full shadow-lg text-white transition-all duration-300 z-50 hover:scale-110",
      ...
      <div
        className={cn(
          "fixed bottom-6 right-6 w-80 sm:w-[400px] h-[600px] max-h-[85vh] bg-[#1a1f2e] border border-gray-800 rounded-2xl shadow-2xl flex flex-col transition-all duration-300 z-50 overflow-hidden",
